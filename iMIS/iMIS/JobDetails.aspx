<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostBack="true" CodeBehind="JobDetails.aspx.cs" Inherits="iMIS.JobDetails" %>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <div>
        ...
        <h2 align="center">Add a Job to the 'Death Star'</h2>
            <h5 align="center">(Only jobs for the companies already present on Death Star can be added)</h5>
            <br />
...
<h1><small>Job Details</small></h1>
    ...
    <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="* Field Required"
            ...
            CssClass="rfvlabel" ValidationGroup="addjob"></asp:RequiredFieldValidator>
    </td>           
             <td></td>
    <td>Position</td>
        ...
        <tr>
            ...
            CssClass="rfvlabel" ValidationGroup="addjob"></asp:RegularExpressionValidator>
            </td>
            <td></td>
        </tr>
        <tr>
        ...
        <tr>
           ...
           <asp:Button ID="submitaddjob" runat="server" class="btn btn-success" Text="+ Add Job" Font-Size=Large
              OnClick="submitaddjob_Click" ValidationGroup="addjob" />
           </td>
