<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sfiltercj.aspx.cs" Inherits="iMIS.sfiltercj" %>
...
<body>
    ...
    <asp:Image ID="logo" ImageUrl="~/logo.jpg" runat="server" Height="151px" Width="1036px" />
         ...
         <hr />
        <div>
     <h2 align="center">Companies from a Specific Country</h2>
            </div>
        <div>
    
        
        
    <asp:Repeater ID="sFiltercj" runat="server">
        <HeaderTemplate>
