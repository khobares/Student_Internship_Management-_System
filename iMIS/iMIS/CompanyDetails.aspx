<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyDetails.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="iMIS.CompanyDetails" %>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <br /><br /><br />
    <div>
        <form id="companydetails" runat="server">
        <h2 align="center">Add a Company to the 'Death Star'</h2>
            <br />
...
<%--------------------------------------------Company Details--------------------------------------------------%>    
    ...
    <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="* Field Required"
            ...
            CssClass="rfvlabel" ValidationGroup="addcomp"></asp:RequiredFieldValidator>
    </td>           
             <td></td>
         <td>
        Company Address
    ...
    <td>
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ErrorMessage="* Invalid URL."
            ...
            CssClass="rfvlabel" ValidationGroup="addcomp"></asp:RegularExpressionValidator>
    </td>           
                 <td></td>
        </tr>
        <tr>
    ...
    <td>
        <TextArea ID="iCNotes" class="form-control" runat="server"></TextArea>
    </td><td></td>
        </tr>
<%--------------------------------------------Contact Person--------------------------------------------------%>
    <tr><td></td>
    ...
    <td>
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="* Characters Only." 
            ...
            CssClass="rfvlabel" ValidationExpression="^([a-zA-Z]*)$" ValidationGroup="addcomp"></asp:RegularExpressionValidator>
    </td>           
             <td></td>
            <td>Last Name</td>
             <td>
    ...
    <td>
        ...
        <tr>
           ...
           <asp:Button ID="submitaddcomp" runat="server" class="btn btn-success" Text="+ Add Company" Font-Size=Large
              OnClick="submitaddcomp_Click" ValidationGroup="addcomp" />
           </td>
       </tr>
