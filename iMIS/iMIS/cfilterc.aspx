<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cfilterc.aspx.cs" Inherits="iMIS.cfilterc" %>
...
<body>
    <form id="cFilterc1" runat="server">
    ...
    <asp:Image ID="logo" ImageUrl="~/logo.jpg" runat="server" Height="151px" Width="1036px" />
         ...
         <hr />
        <div>
     <h2 align="center">All Companies from Particular Country</h2>
            </div>
        <div>
    
        
        
    <asp:Repeater ID="cFilterc" runat="server">
        <HeaderTemplate>
