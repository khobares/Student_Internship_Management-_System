 <%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostBack="true" CodeBehind="UpdateStudent.aspx.cs" Inherits="iMIS.UpdateStudent" %>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <div>
        ...
        <h2 align="center">Update a Student in 'Death Star'</h2>
            <br />
...
<%-- ----------------------------------------Personal Details----------------------------------------------- --%>
    ...
    <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="* Field Required."
            ...
            CssClass="rfvlabel" ValidationGroup="upstu"></asp:RequiredFieldValidator>
    ...
    <td>
        <select class="form-control" id="iStatus" runat="server">
   ...
   <td>
    ...
    <td>
        <select class="form-control" id="iTerm" runat="server">
                    <option>Fall</option>
    ...
    <td>
        ...
        <tr>
           ...
           <asp:Button ID="submitupstu" runat="server" class="btn btn-success" Text="+ Update Student" Font-Size=Large
              OnClick="submitupstu_Click" ValidationGroup="upstu" />
           </td>
        </tr>
<%-- ----------------------------------------UnderGrad Details---------------------------------------------- --%>                
        <tr><td></td>
    ...
    <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="* Field Required."
            ...
            CssClass="rfvlabel" ValidationGroup="upug"></asp:RequiredFieldValidator>
...
<%-- -------------------------------------------Grad Details------------------------------------------------ --%>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="* Field Required."
            ...
            CssClass="rfvlabel" ValidationGroup="upg"></asp:RequiredFieldValidator>
...
<h1><small>Certifications</small></h1>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="* Field Required."
            ...
            CssClass="rfvlabel" ValidationGroup="upc"></asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator15" runat="server" ErrorMessage="* Numbers Only."
            ...
            CssClass="rfvlabel" ValidationGroup="upc"></asp:RegularExpressionValidator>
    </td>
        <td></td>
    <td>
        Certification
...
<h1><small>Skills</small></h1>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="* Field Required."
            ...
            CssClass="rfvlabel" ValidationGroup="ups"></asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator16" runat="server" ErrorMessage="* Numbers Only."
            ...
            CssClass="rfvlabel" ValidationGroup="ups"></asp:RegularExpressionValidator>
    </td>
            <td></td>
    <td>
        Skill
...
<%-- ------------------------------------------Work Experience---------------------------------------------- --%>                
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="* Field Required."
            ...
            CssClass="rfvlabel" ValidationGroup="upw"></asp:RequiredFieldValidator>
