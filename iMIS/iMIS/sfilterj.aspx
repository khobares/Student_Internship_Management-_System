<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sfilterj.aspx.cs" Inherits="iMIS.sfilterj" %>
...
<body>
    <form id="sFilterj1" runat="server">
    <div align="center">
    <asp:Image ID="logo" ImageUrl="~/logo.jpg" runat="server" Height="151px" Width="1036px" />
   </div>
         <hr />
        <div>
     <h2 align="center">Student and Job Details</h2>
            </div>
        <div>
    
        
        
    <asp:Repeater ID="sFilterj" runat="server">
        <HeaderTemplate>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("iC_Name") %>' />
                </td>
                <td>
